...
export const verbItems: LexItem[] = [
  ...
  /* ---- merge from the old Verbs reference (2026-09-15) ---- */
  v("vb-everyday", "find", "trovare", "I can't find my glasses."),
  v("vb-everyday", "put", "mettere", "Put the milk in the fridge."),
  v("vb-everyday", "take", "prendere", "Take an umbrella with you."),
  v("vb-everyday", "try", "provare/cercare di", "Try to get some rest."),
  v("vb-daily", "wear", "indossare", "She wears glasses for reading."),
  v("vb-movement", "come", "venire", "Come here for a second."),
  v("vb-movement", "bring", "portare (verso)", "Bring your notes to the lesson."),
  v("vb-movement", "catch", "prendere/afferrare", "Run or you'll miss the bus — catch it!"),
  v("vb-travel", "fly", "volare", "We fly to London on Monday."),
  v("vb-travel", "rent", "affittare/noleggiare", "We rented a car for the week."),
  v("vb-communication", "call", "chiamare", "Call me when you arrive."),
  v("vb-communication", "speak", "parlare", "Do you speak English?"),
  v("vb-communication", "talk", "parlare/chiacchierare", "We talked for hours."),
  v("vb-communication", "mean", "significare/intendere", "What does this word mean?"),
  v("vb-communication", "agree", "essere d'accordo", "I agree with you completely."),
  v("vb-thinking", "seem", "sembrare", "She seems tired today."),
  v("vb-feeling", "prefer", "preferire", "I prefer tea to coffee."),
  v("vb-work", "plan", "pianificare", "We're planning a new project."),
  v("vb-money", "buy", "comprare", "I need to buy a new laptop."),
  v("vb-money", "sell", "vendere", "They sell fresh fish here."),
  v("vb-money", "cost", "costare", "How much does it cost?"),
  v("vb-health", "hurt", "far male/ferire", "My leg hurts when I run."),
  v("vb-senses", "see", "vedere", "I can see the sea from here."),
];
