...
export const verbUnits: Unit[] = [
  ...
  vb("A2", "cooking", "Cooking & food verbs", "Concrete"),
  vb("A2", "senses", "Verbs of the senses", "Concrete"),
  ...
  vb("B1", "money", "Money verbs", "Domains"),
  vb("B1", "health", "Health verbs", "Domains"),
  vb("B1", "technology", "Technology verbs", "Domains"),
...
export const phrasalUnits: Unit[] = [
  ...
  ...["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "y", "z"].map(
...
export const vocabularyUnits: Unit[] = [
  ...
  voc("B1", "art", "Art & literature", "Life & society"),
  ...
  voc("B2", "crime-law", "Crime & law", "Abstract & formal"),
...
export const adjectiveUnits: Unit[] = [
  adj("A1", "colours", "Colours"),
  adj("A2", "appearance", "Appearance"),
  adj("A2", "size-shape", "Size & shape"),
  adj("A2", "describing-things", "Describing things"),
  adj("A2", "taste-food", "Taste & food"),
  adj("A2", "temperature", "Temperature & weather"),
  adj("A2", "age-time", "Age & time"),
  ...
  adj("B1", "sound-texture", "Sound & texture"),
  adj("B2", "work", "Work"),
...
export const adverbUnits: Unit[] = [
  ...
  adv("B1", "probability", "Adverbs of probability"),
  adv("B2", "sentence", "Sentence adverbs"),
  adv("B2", "linking", "Linking adverbs"),
  adv("B2", "focusing", "Focusing adverbs"),
